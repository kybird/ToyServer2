...
public:
    ...
    void Initialize(int32_t id, int32_t ownerId, int32_t skillId) {
        _id = id;
        _ownerId = ownerId;
        _skillId = skillId;
        _damage = 0;
    ...
    int32_t GetSkillId() const { return _skillId; }

    void SetDamage(int32_t dmg) { _damage = dmg; }
    int32_t GetDamage() const { return _damage; }
